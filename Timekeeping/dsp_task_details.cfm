	...
	<div class="span6">
		...
		<div class="row-fluid">
			...
			<div class="span4">
				...
				<input type="date" name="due_date" id="due_date" min="#application.application_specific_settings_workstream_start_date#" value="#dateformat(get_task_details.due_date,'yyyy-mm-dd')#" maxlength="10" required="required" class="span11 date" />
