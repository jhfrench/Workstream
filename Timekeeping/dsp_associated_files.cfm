...
<div class="btn-group">
	<a href="index.cfm?fuseaction=common_files.file_attach&task_id=#attributes.task_id#" target="utility" title="Associate a file path to this task." class="btn btn-mini"><i class="icon-folder-open"></i> Attach</a>
	<a href="index.cfm?fuseaction=common_files.file_detach&task_id=#attributes.task_id#" target="utility" title="Remove a file path from this task." class="btn btn-mini"><i class="icon-remove-sign"></i> Remove</a>
</div>
</cfoutput>