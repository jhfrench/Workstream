...
<cfsilent>
 ...
 --->
			...
			<img src="#request.dir_level##application.application_specific_settings.image_dir#file_attach.gif" valign="bottom" width="60" height="20" alt="Associate a file path to this task." border="0"  onclick="window.open('index.cfm?fuseaction=common_files.file_attach', 'files', 'toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=0,copyhistory=0,width=420,height=210');" tabindex="#incrementvalue(tabindex)#">
			<img src="#request.dir_level##application.application_specific_settings.image_dir#file_detach.gif" valign="bottom" width="60" height="20" alt="Remove a file path from this task." border="0"  onclick="javascript:window.open('index.cfm?fuseaction=common_files.file_detach&task_id=#attributes.task_id#', 'files', 'toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=1,copyhistory=0,width=350,height=350');" tabindex="#incrementvalue(tabindex)#">
			</cfoutput>
