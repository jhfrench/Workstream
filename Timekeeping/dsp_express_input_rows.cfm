...
<cfoutput>
	<tr align="center" class="RegText">
		...
		<td align="center" class="RegText">
			<input type="text" name="hours" size="4" class="RegText">
		</td>

		<td align="center" class="RegText">
			<select name="task_id" size="1" class="RegText">
		...
		<td align="center" class="RegText">
			<textarea rows="<cfoutput>#session.workstream_express_notes_height#" cols="#session.workstream_express_notes_width#" name="notes_#DEX#"</cfoutput> wrap="soft" class="RegText"></textarea>
		</td>
