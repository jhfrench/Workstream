...
<cfmail query="send_isay_link" to="#email_to#" from="#application.application_specific_settings.system_email_sender#" subject="Your recent IT Experience" type="html" server="#application.email_server_name#">
<p>
