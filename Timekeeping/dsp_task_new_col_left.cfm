...
<div class="row-fluid">
	...
	<div class="span6">
			...
			<input type="date" name="date_start" id="date_start" min="#application.application_specific_settings.workstream_start_date#" value="#dateformat(now(), 'yyyy-mm-dd')#" maxlength="10" required="required" class="span6 date" />
			<label for="due_date" class="h5">Date Due</label>
			<input type="date" name="due_date" id="due_date" min="#application.application_specific_settings.workstream_start_date#" maxlength="10" required="required" class="span6 date" />
			...
			<input type="number" name="budgeted_hours" id="budgeted_hours" step="1" min="0" max="999" class="span6" />
