...
<!--Timekeeping/qry_convert_qa.cfm
	Author: Jeromy F -->
<cfsilent>
	<!---FUSEDOC
	||
	...
	Edits:
	$Log$
Revision 1.1  2005/03/09 18:23:17  stetzer
<>
...
added $log $ for edits.  To all CFM files that have fusedocs.
 ...
 --->
<cfquery name="convert_qa" datasource="#application.datasources.main#">
SELECT name, lname
FROM Emp_Contact
WHERE emp_id = #get_task_details.qa_id#
</cfquery>
</cfsilent>
