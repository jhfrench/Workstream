 ...
 --->
	...
	<tr bgcolor="#78A0EB" align="center">
		<td bgcolor="#78A0EB" colspan="4" class="RegTextWhite">
			...
			<input type="number" name="express_input_rows" id="express_input_rows" value="#session.workstream_express_input_rows#" step="1" min="0" max="100" required="required" class="span5" /> lines of input (max = 30), a width of 
			<input type="number" name="express_notes_width" id="express_notes_width" value="#session.workstream_express_notes_width#" step="1" min="0" max="100" required="required" class="span5" /> columns for the notes box and 
			<input type="number" name="express_notes_height" id="express_notes_height" value="#session.workstream_express_notes_height#" step="1" min="0" max="100" required="required" class="span5" /> row(s). Your folder box is set to a height of
			<input type="number" name="express_tree_height" id="express_tree_height" value="#session.workstream_express_tree_height#" step="1" min="0" max="100" required="required" class="span5" />
