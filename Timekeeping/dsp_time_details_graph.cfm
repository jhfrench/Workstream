...
<cfoutput>
	<div class="row-fluid">
		<div class="span12">
			<h5>Time Used</h5>
			<p>#variables.hours_used#<cfif get_task_details.budgeted_hours> out of #get_task_details.budgeted_hours# budgeted hours (#decimalformat(get_task_details.percent_used)#%)<cfif get_task_details.percent_used GT 100><span class="badge badge-important"><i class="icon-fire icon-white"></i></span></cfif></cfif></p>
