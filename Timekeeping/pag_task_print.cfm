...
<table align="center" border="1" bordercolor="#000000" cellpadding="3" cellspacing="0" width="95%">
	<cfmodule template="../common_files/dsp_section_title.cfm" section_title="&nbsp;Task:&nbsp; #get_task_details.task_name# (#attributes.task_id#) - as of #dateformat(now(),"m/d/yyyy")# at #hour(now())#:#minute(now())#" section_color="000000" colspan="7" gutter=0 title_class="HeadTextWhite">
