...
<div class="row-fluid">
	<div classs="span12">
		<label for="project_id">Customer &amp; Project <cfoutput><img src="#application.application_specific_settings.image_dir#popup_icon.gif" valign="bottom" width="14" height="12" alt="#alt#" border="0" onclick="OpenProjectWindow('project_id');" /></cfoutput></label>
