...
<cfsilent>
 ...
 --->
<!--- $issue$: why is this query running, and why might it be in a loop? Can it be removed if we alter Timekeeping/qry_insert_notes.cfm to include a RETURNING clause? --->
