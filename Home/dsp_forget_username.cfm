...
<cfif variables.username_found_ind>
	<div class="alert alert-success"><cfif NOT comparenocase(attributes.fuseaction, "Home.forget_username")>Your username was sent to your email at <cfoutput>'#trim(xmlformat(attributes.email_address))#'</cfoutput>.<br /> Please go to the <a href="index.cfm?fuseaction=Home.login" style="color:yellow;"><cfoutput>#application.product_name#</cfoutput> home page</a> and log in with your username</cfif>.
<cfelse>
