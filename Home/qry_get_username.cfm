...
SELECT User_Account.user_account_id, User_Account.created_date AS password_created_date, User_Account.user_name,
	Link_User_Account_Status.account_status_id, User_Password.password, User_Password.created_by AS password_created_by,
	Demographics.first_name, Demographics.last_name, Demographics.email_address,
...
WHERE Link_User_Account_Status.active_ind=1
	...
	AND User_Account.user_name=<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(attributes.user_name)#" maxlength="4000"><cfelse>
	AND Demographics.email_address=<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(attributes.email_address)#" maxlength="4000">
