...
<cfoutput query="get_module_commands">
	<cfswitch expression="#get_module_commands.navigation_type_id#">
		<cfcase value="2">
			...
			<tr>
				<td bgcolor="##2C6399">
					<span style="padding-bottom:2px; float:left;color:white;" onclick="Element.toggle('element_#variables.parent_counter#');Element.toggle('menu_minus_#variables.parent_counter#');Element.toggle('menu_plus_#variables.parent_counter#');return false;"><img src="images/expand.gif" alt="View Current Year details" id="menu_plus_#variables.parent_counter#" style="cursor: n-resize;" /><img src="images/collapse.gif" alt="Hide Current Year details" height="9" width="9" id="menu_minus_#variables.parent_counter#" style="display:none;cursor: e-resize;" />&nbsp;#business_function_description#</span>
				</td>
			</tr>
		</cfcase>
		<cfcase value="3">
...
<table cellspacing="1" cellpadding="3" border="0" width="100%" align="center" style="border:1px solid white;" summary="Table displays administration options only available to select developers.">
	<tr>
		<td bgcolor="#2C6399">
			<span style="padding-bottom:2px; float:left;color:white;" onclick="Element.toggle('element_ln2');Element.toggle('menu_minus_ln2');Element.toggle('menu_plus_ln2');return false;"><img src="images/expand.gif" alt="View Current Year details" id="menu_plus_ln2" style="cursor: n-resize;" /><img src="images/collapse.gif" alt="Hide Current Year details" height="9" width="9" id="menu_minus_ln2" style="display:none;cursor: e-resize;" />&nbsp;Admin Tasks</span>
		</td>
	</tr>
...
<table cellspacing="1" cellpadding="3" border="0" width="100%" align="center" style="border:1px solid white;" summary="Table displays administration options only available to select developers.">
	<tr>
		<td bgcolor="#2C6399">
			<span style="padding-bottom:2px; float:left;color:white;" onclick="Element.toggle('element_ln1');Element.toggle('menu_minus_ln1');Element.toggle('menu_plus_ln1');return false;"><img src="images/expand.gif" alt="View Current Year details" id="menu_plus_ln1" style="cursor: n-resize;" /><img src="images/collapse.gif" alt="Hide Current Year details" height="9" width="9" id="menu_minus_ln1" style="display:none;cursor: e-resize;" />&nbsp;Help</span>
		</td>
	</tr>
