...
<table border="0" cellspacing="0" cellpadding="0" width="100%" summary="table head describes the data held in the tables below">
	<tr valign="top">
		...
		<td class="number"><form action="#application.application_specific_settings.calendar_location#" method="post" id="calForm" name="calForm" target="_blank" style="display: inline;"><input type="hidden" name="uname" value="#variables.variables.encoded_username#">
