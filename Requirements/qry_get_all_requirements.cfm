...
SELECT Requirement.requirement_id, Requirement.requirement_number, Requirement.description AS requirement,
	...
	Link_Screen_Requirement.sort_order, REF_Business_Function.acronym, REF_Product_Version.description AS product_version
...
ORDER BY REF_Module.sort_order, REF_Business_Function.sort_order, REF_Product_Version.sort_order,
	REF_Requirement_Type.sort_order, Requirement.requirement_number, Link_Screen_Requirement.sort_order
</cfquery>