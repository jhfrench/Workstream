...
<cfsilent>
	...
	Edits:
	$Log$
Revision 1.0  2005/02/15 21:00:52  daugherty
Initial revision
...
added $log $ for edits.  To all CFM files that have fusedocs.
	...
	<cfquery name="insert_notes" datasource="#application.datasources.main#">
         INSERT INTO notes
	    (note, emp_id, notes_type_id, date)
	    VALUES('#attributes.note#',#attributes.emp_id#, 6, '#attributes.datefield1#') 
     </cfquery>
	...
	<cfquery name="insert_expense" datasource="#application.datasources.main#">
         INSERT INTO expense
	    (work_date, emp_id, project_id, reimbursement_type_id, notes_id)
	    VALUES('#attributes.datefield1#', #attributes.emp_id#, #attributes.project_id#, #attributes.reimbursement_type_id#, 
	    	#get_notes_id.notes_id#)
     </cfquery>
	...
	<cfquery name="insert_expense_amount" datasource="#application.datasources.main#">
	    ...
	    (expense_type_id, expense_amount, expense_id) 
