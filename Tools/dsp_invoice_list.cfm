...
<cfoutput query="invoice_list">
	<tr<cfif (currentrow MOD 2)> bgcolor="##E1E1E1"</cfif> class="RegText">
		<td class="RegText">
			<cfset StatusMsg=JSStringFormat("(#root_code##Replace(project_code,root_code,"")#) #trim(customers_name)# #trim(Replace(project_name,customers_name,""))#")><a href="javascript:list_to_details('#project_id#|#billable_type_id#');" onmouseover="MM_displayStatusMsg('View details for #StatusMsg#.');return document.MM_returnValue;" onmouseout="MM_displayStatusMsg('');" class="RegText">#StatusMsg#</a>
		</td>
