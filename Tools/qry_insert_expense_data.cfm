...
<cfelse>
	...
	INSERT INTO Expense (user_account_id, date_incurred, payee_name,
		amount, expense_category_id, project_id,
		client_billable_ind, expense_note,
		paid_by_id
		<cfif isdefined("attributes.supervisor_settings")>
			,supervisor_approval_user_account_id,
		...
		<cfif isdefined("attributes.accounting_pro_settings")>
			...
			expense_status_id,
			accounting_approval_user_account_id
