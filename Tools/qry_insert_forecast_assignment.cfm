	...
	<cfloop query="get_prospectives">
		<cfif isdefined("attributes.accept_#task_id#")>
			<cfloop list="#emp_id_loop#" index="ii">
				...
				INSERT INTO Forecast_Assignment(forecast_id, task_id, emp_id, hours_budgeted)
				VALUES (#variables.forecast_id#, #task_id#, #ii#, #evaluate("attributes.t#task_id#_#ii#")#)

				/*update team membership*/
				DELETE Team
				WHERE Team.roll_id=4
