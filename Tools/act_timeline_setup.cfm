...
SELECT #insert_project_planning.project_planning_id# AS project_planning_id, user_account_id
FROM User_Account
WHERE user_account_id IN (#variables.user_account_id_list#)
</cfquery>
<cfset dir_to_make = '\\192.168.0.152\attatched_files\workstream\Project_Planning\#insert_project_planning.project_planning_id#'><!--- $issue$: what do we do with this? --->
