...
<cfsilent>
	...
	<tr>
		...
		<td>
			...
			<input type="date" name="DateField1" id="from_date" min="#dateformat(application.application_specific_settings.workstream_start_date, 'yyyy-mm-dd')#" max="#dateformat(now()+30, 'yyyy-mm-dd')#" value="#dateformat(variables.datefield1, 'yyyy-mm-dd')#" maxlength="10" required="required" class="span6 date" />
			<!-- Use CF to create validation <cfinput type="text" name="DateField1" message="Enter a date." validate="date" required="yes" size="12"> -->
		</td>
</tr>
<tr>
