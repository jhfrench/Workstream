...
<tr<cfif currentrow MOD 2> bgcolor="##E1E1E1"</cfif>>
	<td align="left"><a href="index.cfm?fuseaction=expense_entry<cfif isdefined('attributes.order_by')>&order_by=#attributes.order_by#</cfif>&expense_id=#expense_id#&supervisor_flag=#variables.supervisor_flag#">#dateformat(date_incurred, "mm/dd/yyyy")#</a></td>
	<td align="left"><a href="index.cfm?fuseaction=expense_entry<cfif isdefined('attributes.order_by')>&order_by=#attributes.order_by#</cfif>&expense_id=#expense_id#&supervisor_flag=#variables.supervisor_flag#">#dateformat(date_entered, "mm/dd/yyyy")#</a></td>
	<td align="left"><a href="index.cfm?fuseaction=expense_entry<cfif isdefined('attributes.order_by')>&order_by=#attributes.order_by#</cfif>&expense_id=#expense_id#&supervisor_flag=#variables.supervisor_flag#">#dateformat(date_approved, "mm/dd/yyyy")#</a></td>
