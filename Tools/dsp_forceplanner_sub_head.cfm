...
<cfoutput>
	<tr>
		...
		<cfif variables.show_submit_button>
			&nbsp;<input type="reset" value="Reload Form"><br />
			&nbsp;<input type="button" name="submit_button" value="Assign Tasks" onkeypress="document.forceplanner.submit();" onclick="document.forceplanner.submit();"><br />
