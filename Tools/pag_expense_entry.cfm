...
<table border="0" cellpadding="4" cellspacing="0" width="100%">
	...
	<tr>
		...
		<td colspan="6" align="center">
			Specify: <br />Date Range: <input type="date" name="begin_date" id="begin_date" min="#application.application_specific_settings_workstream_start_date#" max="#dateformat(now()+30, 'yyyy-mm-dd')#" maxlength="10" class="span6 date" /> to <input type="date" name="end_date" id="end_date" min="#application.application_specific_settings_workstream_start_date#" max="#dateformat(now()+30, 'yyyy-mm-dd')#" maxlength="10" class="span6 date" /><br />
