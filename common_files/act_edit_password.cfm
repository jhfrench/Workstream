...
<cfif get_user_information.recordcount EQ 1 AND len(get_user_information.email_address)>
	<cfscript>
		variables.url_to_application="https://#cgi.http_host##cgi.script_name#";
		
		attributes.email_recipients_demographics_id=get_user_information.demographics_id;
		attributes.reply_to=application.application_specific_settings.system_email_sender;
		attributes.subject="#application.product_name# Password Reset";
		attributes.email_body="<p>Your #application.product_name# password has been set to:
...
<p>Please contact the Help Desk at 202-358-HELP(4357) if you did not request your password to be reset.</p>";
		variables.created_by=0;
	</cfscript>
    <cfmail to="#get_user_information.email_address#" from="#application.application_specific_settings.system_email_sender#" subject="#attributes.subject#" server="#application.email_server_name#" type="html">
