...
--->
<cfparam name="attributes.m_p_task_status_id" default="0">
<cfquery name="get_ref_m_p_status" datasource="#application.datasources.main#">
SELECT m_p_task_status_id, description, sort_order
FROM REF_m_p_status
WHERE <cfif attributes.m_p_task_status_id NEQ 0>m_p_task_status_id=#attributes.m_p_task_status_id#<cfelse>active_ind=1</cfif>
ORDER BY sort_order
</cfquery>
