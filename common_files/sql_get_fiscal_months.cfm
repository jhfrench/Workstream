...
<fusedoc language="ColdFusion MX" specification="2.0" template="sql_get_variance_explanation_months.cfm">
	...
	<properties>
		<history email="jeromy.h.french@nasa.gov" author="Jeromy French" type="create" date="2/21/2007" role="FuseCoder" comments="Created File">
			$Id:$
		</history>
	</properties>
	<IO>
