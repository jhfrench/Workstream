...
FROM Customer
	...
	INNER JOIN Team ON Task.task_id=Team.task_id
		...
		AND Team.user_account_id=<cfif isdefined("attributes.user_account_id")><cfqueryparam value="#attributes.user_account_id#" cfsqltype="cf_sql_integer" /><cfelse><cfqueryparam value="#variables.user_identification#" cfsqltype="cf_sql_integer" /></cfif>
		AND (
				(
	...
	INNER JOIN Link_Project_Company ON Link_Project_Company.project_id=Project.project_id
		AND Link_Project_Company.company_id IN (<cfqueryparam value="#session.workstream_company_id#" cfsqltype="cf_sql_integer" list="true" />)
