...
<cfoutput>
SELECT Hierarchy_Assignment.parent_organization_id, SUM(Hierarchy_Assignment.active_ind) AS child_count, SUM(NVL(Workflow_Progress.active_ind,0)) AS workflow_count,
