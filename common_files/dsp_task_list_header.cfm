...
<thead>
	<tr>
		<th>
			<a href="javascript:order_by('task_id');" title="Order by the task ID."><abbr title="task id">ID</abbr><cfif NOT compare(variables.task_list_order_column,"task_id")> <i class="icon-chevron-<cfif variables.task_list_order_down_ind>down<cfelse>up</cfif>"></i></cfif></a>
		</th>
		<th>
		...
		<th>
			<a href="javascript:order_by('task_name');" title="Order by the name of the task.">Name<cfif NOT compare(variables.task_list_order_column,"task_name")> <i class="icon-chevron-<cfif variables.task_list_order_down_ind>down<cfelse>up</cfif>"></i></cfif></a>
		</th>
		<th>
		...
		<th>
			<a href="javascript:order_by('priority');" title="Order by Priority.">Priority<cfif NOT compare(variables.task_list_order_column,"priority")> <i class="icon-chevron-<cfif variables.task_list_order_down_ind>down<cfelse>up</cfif>"></i></cfif></a>
		</th>
		<th>
		...
		<th>
			<a href="javascript:order_by('task_status');" title="Order by the task status.">Status<cfif NOT compare(variables.task_list_order_column,"task_status")> <i class="icon-chevron-<cfif variables.task_list_order_down_ind>down<cfelse>up</cfif>"></i></cfif></a>
		</th>
		<th>
