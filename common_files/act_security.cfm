...
<cfelse>
	...
	<cfif len(cgi.http_referer) AND NOT (findnocase("127.0.0.1", cgi.http_referer) OR findnocase("localhost", cgi.http_referer) findnocase("florence", cgi.http_referer) OR findnocase("192.168.1.3", cgi.http_referer))>
