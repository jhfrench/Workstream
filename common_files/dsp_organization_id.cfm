...
<fusedoc language="ColdFusion MX" specification="2.0" template="dsp_organization_id.cfm">
	<responsibilities>
		I display the my NVDB page to the user
	</responsibilities>
	<properties>
		<history email="jeromy.h.french@nasa.gov" author="Jeromy French" type="create" date="3/23/2009" role="FuseCoder" comments="Created File">
			$Id:$
		</history>
	</properties>
	<IO>
