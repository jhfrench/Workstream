...
<cfparam name="attributes.key_query" default="get_nsm_levels">
...
<cfswitch expression="#attributes.key_query#">
	...
	<cfcase value="get_level_hierarchy_level_id_organization_id">
		...
		<cfinclude template="qry_get_terminal_nsm_levels.cfm">
		<cfinclude template="qry_get_nsm_levels.cfm">
	...
	<cfdefaultcase>
		...
		<cfinclude template="qry_get_terminal_nsm_levels.cfm">
		<cfinclude template="qry_get_nsm_levels.cfm">
		<cfinclude template="qry_get_nsm_level_options.cfm">
	</cfdefaultcase>
</cfswitch>