<!-- common_files/dsp_view_user_access.cfm
...
<div class="datachart" style="border:1px solid ##999999">
	<cfoutput query="get_user_information">
		...
		<cfmodule template="qry_get_user_module_access.cfm" program_year_id="#attributes.program_year_id#" user_account_id="#get_user_information.user_account_id#">
		<cfmodule template="qry_get_user_privileges.cfm" program_year_id="#attributes.program_year_id#" user_account_id="#user_account_id#" privilege_id="#valuelist(get_ref_privilege.privilege_id)#">
