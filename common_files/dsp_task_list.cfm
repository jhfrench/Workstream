...
<cfset variables.status_message=jsstringformat(task_name)>
	<tr>
		...
		<td><cfif status_id NEQ 7 AND datecompare(now(), date_due, "d") GTE 0><img src="#application.application_specific_settings.image_dir#<cfif datecompare(now(), date_due, "d") EQ 0>not_started<cfelse>overdue</cfif>.gif" width="17" height="17" alt="" border="0">&nbsp;</cfif>#task_status#</td>
