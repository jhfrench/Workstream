...
--->
<!---
<cfdirectory directory="#cffile.ServerDirectory#" name="dirQuery" action="LIST" recurse="yes" filter="*.*">
<cfdump var="#dirQuery#">
--->
...
<cftry>
	<cffile action="RENAME" source="#cffile.ServerDirectory#/#urlencodedformat(cffile.serverfile)#" destination="#cffile.ServerDirectory#/#variables.archived_file_name#">
	<cfcatch>
