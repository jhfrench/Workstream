...
<cfif session.workstream_show_options>
	<cfif NOT comparenocase(listlast(attributes.fuseaction, '.'),"engagement_list")>&nbsp;&nbsp;<label for="show_closed_engagements" class="checkbox" title="Show completed projects"><input type="checkbox" name="show_closed_engagements" id="show_closed_engagements" onclick="javascript:form.submit();"<cfif isdefined("session.workstream_show_closed_engagements") AND session.workstream_show_closed_engagements> checked</cfif>>Completed projects</label></cfif>
	<label for="show_on_hold" class="checkbox" title="Show tasks on hold"><input type="checkbox" name="show_on_hold" id="show_on_hold" onclick="javascript:form.submit();"<cfif isdefined("session.workstream_show_on_hold") AND session.workstream_show_on_hold> checked</cfif>>Tasks on hold</label>
	<label for="show_closed" class="checkbox" title="Show completed tasks"><input type="checkbox" name="show_closed" id="show_closed" onclick="javascript:form.submit();"<cfif isdefined("session.workstream_show_closed") AND session.workstream_show_closed> checked</cfif>>Completed tasks</label>
	<label for="show_team" class="checkbox" title="Show team tasks"><input type="checkbox" name="show_team" id="show_team" onclick="javascript:form.submit();"<cfif isdefined("session.workstream_show_team") AND session.workstream_show_team> checked</cfif>>Team Tasks</label>
</cfif>
</cfoutput>
</cfform>