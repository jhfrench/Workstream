...
<fusedoc language="ColdFusion MX" specification="2.0" template="act_log_upload.cfm.cfm">
	<responsibilities>
		I log a data upload attempt by the user. I INSERT INTO the LOG_Upload table the date/time, variables.user_identification, cgi.REMOTE_ADDR, file being uploaded (original name and archived name), and the upload_source_id.
	</responsibilities>
	<properties>
