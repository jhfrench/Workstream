...
<fusedoc language="ColdFusion MX" specification="2.0" template="act_log_upload.cfm.cfm">
	...
	<properties>
		<history email="jeromy.h.french@nasa.gov" author="Jeromy French" type="create" date="8/17/2007" role="FuseCoder" comments="Created File">
			$Id:$
		</history>
	</properties>
	<IO>
...
VALUES (SYSDATE, '#session.user_account_id#', '#cgi.remote_addr#',
...
SELECT LOG_UPLOAD_SEQ.currval AS upload_id
FROM Dual
</cfquery>
