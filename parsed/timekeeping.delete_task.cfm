...
<!--- circuit: Timekeeping --->
<!--- fuseaction: delete_task --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "Timekeeping">
<cfset myFusebox.thisFuseaction = "delete_task">
<cftry>
...
<cfset request.pagetitle = "Delete Task" />
<cftry>
<cfoutput><cfinclude template="../Timekeeping/pag_delete_task.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 19 and right(cfcatch.MissingFileName,19) is "pag_delete_task.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse pag_delete_task.cfm in circuit Timekeeping which does not exist (from fuseaction Timekeeping.delete_task).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cftry>
