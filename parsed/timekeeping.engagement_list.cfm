...
<!--- circuit: Timekeeping --->
<!--- fuseaction: engagement_list --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "Timekeeping">
<cfset myFusebox.thisFuseaction = "engagement_list">
<cftry>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse pag_engagement_list.cfm in circuit Timekeeping which does not exist (from fuseaction Timekeeping.engagement_list).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cftry>
