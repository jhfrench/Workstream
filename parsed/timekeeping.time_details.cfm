...
<!--- circuit: Timekeeping --->
<!--- fuseaction: time_details --->
<cftry>
<cfset myFusebox.thisPhase = "requestedFuseaction">
<cfset myFusebox.thisCircuit = "Timekeeping">
<cfset myFusebox.thisFuseaction = "time_details">
<cftry>
...
<cfset request.pagetitle = "Time Details" />
<cftry>
<cfoutput><cfinclude template="../Timekeeping/pag_time_details.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 20 and right(cfcatch.MissingFileName,20) is "pag_time_details.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse pag_time_details.cfm in circuit Timekeeping which does not exist (from fuseaction Timekeeping.time_details).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
<cftry>
