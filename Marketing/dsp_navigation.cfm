...
added $log $ for edits.  To all CFM files that have fusedocs.
 ...
 --->
<!--- <cfloop list="marketing" index="ii"> --->
...
<cfoutput>
			<a href="#request.dir_level#index.cfm?fuseaction=Administration.marketing_options" class="NavText#session.workstream_text_size#">options</a>
		</td>
