...
<cfmodule template="#request.dir_level#common_files/variable_check.cfm" check_variable="attributes.client_code" relocate="Customers/index.cfm?fuseaction=home"/>
<cfinclude template="qry_get_engagements.cfm">
<cfmodule template="../common_files/act_drilldown_form.cfm" function_name="engagement" fuseaction="edit_engagement" field_name="project_id">
<cfmodule template="../common_files/act_drilldown_form.cfm" function_name="open_tasks" fuseaction="open_tasks" field_name="project_id">
