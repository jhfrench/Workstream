...
<cfinclude template="qry_get_flat_rate.cfm">
	<tr valign="top">
		<td colspan="2" class="RegText#session.workstream_text_size#">
			Start: <cfinput type="text" name="start_date" value="#DateFormat(get_flat_rate.rate_start_date,"mm/dd/yy")#" required="yes" validate="date" message="Please enter a proper date for which billing is to begin on this engagement." size="8" class="RegText#session.workstream_text_size#"> End: <cfinput type="text" name="end_date" value="#DateFormat(get_flat_rate.rate_end_date,"mm/dd/yy")#" required="yes" validate="date" message="Please enter a proper date for which billing is to end on this engagement." size="8" class="RegText#session.workstream_text_size#"> Months: <cfinput type="text" name="months" value="#get_flat_rate.months#" required="yes" validate="integer" message="Please enter the number of months over which this engagement will be billed to the customer." size="2" class="RegText#session.workstream_text_size#"><br>
		</td>
		<td width="55%" class="Note#session.workstream_text_size#">
			<ol type="1" start="#variables.start#" class="Note#session.workstream_text_size#">
