...
<cfinclude template="qry_get_flat_rate.cfm">
	<tr valign="top">
		<td colspan="2">
			Start:
			<input type="date" name="start_date" id="start_date" value="#dateformat(get_flat_rate.rate_start_date,'yyyy-mm-dd')#" min="2011-09-01" maxlength="10" required="required" class="span3 date" />
			End:
			<input type="date" name="end_date" id="end_date" value="#dateformat(get_flat_rate.rate_end_date,'yyyy-mm-dd')#" min="2011-09-01" maxlength="10" required="required" class="span3 date" />
		</td>
		<td width="55%" class="Note">
			<ol type="1" start="#variables.start#" class="Note">
