...
<cfoutput>
<cfform name="edit_engagement_main" action="index.cfm?fuseaction=Customers.edit_engagement" method="post" class="form-horizontal">
	<fieldset>
	...
	<cfcase value="4">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<p class="help-block">Specify the per-incident charge that the customer will incur each time a new task is created under this engagement.</p>
			</div>
		</div>
	</cfcase>
</cfswitch>
