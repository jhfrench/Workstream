...
<cfoutput query="customer_change"> 
	<tr>
		...
		<td><select name="active_ind" size="1">
			<option value="1" <cfif Active_Id EQ 1> SELECTED</cfif>>Active</option>
			<option value="0"<cfif Active_Id EQ 0> SELECTED</cfif>>Inactive</option>
</select>
		</td>
	</tr>
</cfoutput>
