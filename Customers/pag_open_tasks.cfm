...
<cfmodule template="../common_files/act_drilldown_form.cfm" function_name="task_details" directory_action="../Timekeeping/" fuseaction="task_details" field_name="task_id">
...
<cfmodule template="../common_files/act_drilldown_form.cfm" function_name="list_to_time" field_name="task_id" directory_action="../Timekeeping/" fuseaction="time_details">
