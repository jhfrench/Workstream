...
SELECT Project.customer_id, Project.description, Project.budget,
	...
	Project.project_end, Project.project_manager_id, Project.file_path,
	Project.date_go_live, Project.LOE, Project.active_ind,
	Link_Project_Project_Status.project_status_id, Link_Project_Project_Health.project_health_id, Latest_Work.first_work_date,
