...
<table class="table table-striped table-bordered table-condensed">
	...
	<cfoutput query="get_open_tasks">
		<tr>
			...
			<td>#task_owner#</td>
			<td><a href="javascript:list_to_task('#task_id#');"><img src="#application.application_specific_settings.image_dir##task_icon#" alt="#ReplaceList(task_description, variables.quote, variables.status_message_replace_with)#" height="16" width="16" border="0">#task_name#</a></td>
			<td>#project_name#</td>
			<td><cfif NOT dateformat(now(), "m/d/yyyy") LT dateformat(date_due, "m/d/yyyy")><img src="#application.application_specific_settings.image_dir#<cfif dateformat(now(), "m/d/yyyy") EQ dateformat(date_due, "m/d/yyyy")>not_started<cfelse>overdue</cfif>.gif" width="17" height="17" alt="" border="0">&nbsp;</cfif>#task_status#</td>
		</tr>
	</cfoutput>
	</tbody>
</table>
