	...
	<div class="control-group">
		...
		<div class="controls">
			<div class="input-prepend">
				...
				<input type="number" name="budget" id="budget" step="1" min="0" required="required" class="span8 number" />
...
<cfcase value="1">
	...
	<div class="control-group">
		...
		<div class="controls">
			<div class="input-prepend">
				<span class="add-on">$</span>
				<input type="number" name="rate" id="rate" step="0.01" min="0" max="9999" required="required" class="span8 number" />
			</div>
...
<cfcase value="3">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="number" name="months" id="months" step="1" min="0" required="required" class="span8 number" />
...
<cfcase value="4">
	...
	<div class="control-group">
		...
		<div class="controls">
			<div class="input-prepend">
				<span class="add-on">$</span>
				<input type="number" name="charge" id="charge" step="1" min="0" max="9999" required="required" class="span8 number" />
				<span class="add-on">.00</span>
			</div>
