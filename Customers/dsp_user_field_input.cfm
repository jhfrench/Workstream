...
<cfinclude template="qry_get_user_field_types.cfm">
	<cfoutput><tr valign="top">
		<td class="RegTextBd">
			...
			Number of #lcase(user_field_type)# form fields: <cfinput type="Text" name="field#type_id#" required="Yes" validate="integer" message="Please enter the number (0 if necessary) of desired #lcase(user_field_type)# form fields." size="2" class="RegText"><br>
		</cfoutput><cfoutput>
		</td>
