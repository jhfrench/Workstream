...
<cfif isdefined("attributes.description")>
	...
	<div class="alert alert-success">
		You have added #attributes.description#.<cfif isdefined("attributes.create_user_account_ind")> You also created a #application.product_name# account for #variables.user_name#. You may <a href='javascript:edit_navigation_access(#attributes.user_account_id#);'>edit this user's access</a> now, or in the future by clicking on the Administration > Manage Users > Manage User Access navigation link. <strong>No password has been created for the new user yet, so they have not been notified of their account.</strong></cfif>
	</div>
	</cfoutput>
