...
<cfsilent>
	...
	Edits:
	$Log$
	Revision 1.1  2005/03/09 18:05:31  stetzer
	<>
...
<cfoutput>
	<tr bgcolor="##c0c0c0">
		...
		<td align="center" colspan="2" class="SubHeadText#session.workstream_text_size#">#variables.project_name# Time</td>
	</tr>
	<tr bgcolor="##c0c0c0">
...
<cfif time_year LT lowest_year><cfset lowest_year=time_year></cfif>
	<tr<cfif (currentrow MOD 2)> bgcolor="##E1E1E1"</cfif>>
		...
		<td align="right" class="RegText#session.workstream_text_size#">#DecimalFormat(efficiency_time)#</td>
		<td align="right" class="RegText#session.workstream_text_size#">#DecimalFormat(efficiency_percent)#</td>
	</tr>
</cfoutput>
</table>
