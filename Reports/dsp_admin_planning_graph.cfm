...
<cfsilent>
	...
	Edits:
	$Log$
	Revision 1.1  2005/03/09 18:04:29  stetzer
	<>

	Revision 1.0  2001-11-05 18:00:09-05  french
...
<cfswitch expression="#session.workstream_text_size#">
	<cfcase value="Lg">
		...
		<cfset graphheight=(admin_planning_main.recordcount*21)+10>
	</cfcase>
	<cfcase value="Md">
		<cfset large="15">
		<cfset small="11">
	...
	<cfdefaultcase>
		...
		<cfset graphheight=(admin_planning_main.recordcount*18)+10>
	</cfdefaultcase>
</cfswitch>
<cfset xaxislabels="">
...
</applet><br>Percent of Admin/Planning time</cfoutput>
