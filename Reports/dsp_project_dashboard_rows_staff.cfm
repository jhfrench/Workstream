...
<!--Reports/dsp_project_dashboard_rows_staff.cfm
	Author: Jeromy F -->
<cfsilent>
	<!--- FUSEDOC
	||
...
<cfform action="index.cfm?fuseaction=project_dashboard">
	<tr>
		<td>&nbsp;</td>
		<td>
			<select name="customer_id" >
				<option value="0" >All Customers</option><cfoutput query="Get_project_Customers">
	...
	<tr>
		<td colspan="100%" class="RegText">
			<br /><a href="index.cfm?fuseaction=Customers.home&project_dashboard_Return=1">Add another project to this Dashboard.</a>
		</td>
	</tr>
