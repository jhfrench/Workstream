...
<table border="0" cellpadding="1" cellspacing="0" width="90%" align="center">
	...
	<tr>
		<td>
			From: 
			<input type="date" name="from_date" id="from_date" min="#application.application_specific_settings_workstream_start_date#" max="#dateformat(now()+30, 'yyyy-mm-dd')#"  maxlength="10"<cfif attributes.required_ind> required="required"</cfif> class="span6 date" />
		...
		<td>
			To: 
			<input type="date" name="through_date" id="through_date" min="#application.application_specific_settings_workstream_start_date#" max="#dateformat(now()+30, 'yyyy-mm-dd')#"  maxlength="10"<cfif attributes.required_ind> required="required"</cfif> class="span6 date" />
