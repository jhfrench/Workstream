...
SELECT Demographics.first_name, Demographics.last_name, Project.project_code,
	...
	</cfif>END AS client_name, REF_Employee_Classification.employee_classification,
...
ORDER BY REF_Employee_Classification.employee_classification, client_name, Demographics.last_name, Demographics.first_name
</cfquery>
</cfsilent>
