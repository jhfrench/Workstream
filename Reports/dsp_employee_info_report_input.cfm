...
<cfsilent>
	...
	Edits:
	$Log$
	Revision 1.1  2005/03/09 18:06:06  stetzer
	<>
...
<cfform action="index.cfm?fuseaction=Reports.HR_Output" method="POST">
	...
	<tr class="SubHeadText#session.workstream_text_size#">
		<td colspan="3">Report Date&nbsp;&nbsp;<cfinput type="Text" name="start_date" required="no" size="15" maxlength="10" validate="date" message="You must enter a valid from date" class="RegText#session.workstream_text_size#"></td>
	</tr>
	<tr class="SubHeadText#session.workstream_text_size#">
	...
	<tr class="SubHeadText#session.workstream_text_size#">	
		<td>
			<select name="report_columns" class="RegText#session.workstream_text_size#" multiple size="10" style="width:145px;">
				<cfloop list="#attributes.report_elements#" index="dex">
					<option value="#dex#">#dex#</option>
				</cfloop>
			</select>
		</td>
		<td align="center"><input type="button" value="Remove >>>" name="remove" style="width:120px;" onclick="javascript: RemoveListItem('report_columns','removed_elements');" class="VSnPSm"><br>
		<input type="button" value="<<< Add" name="add" style="width:120px;" onclick="javascript: RemoveListItem('removed_elements','report_columns');" class="VSnPSm"></td>
		<td>
			<select name="removed_elements" class="RegText#session.workstream_text_size#" multiple size="10" style="width:145px;">
					<option></option>
			</select>
		</td>
	</tr>	
	<tr>
		<td align="center" colspan="3">
			<input type="button" name="Get_Report" value="Generate Report" class="RegText#session.workstream_text_size#" onclick="submit_form();">
		</td>
	</tr>	
</cfform>
</cfoutput>
