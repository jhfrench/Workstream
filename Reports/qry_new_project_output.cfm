...
<!--Reports/qry_new_project_output.cfm
	Author: Jeromy F -->
<cfsilent>
	<!--- FUSEDOC
	||
...
<cfquery name="new_project_output" datasource="#application.datasources.main#">
SELECT COALESCE(Project_By_Month.root_code,'0') AS root_code, COALESCE(Project_By_Month.customer_name,'NO NEW projectS') AS customer_name, ABCD.Month AS month_entered,
	ABCD.year AS year_entered, COALESCE(Project_By_Month.project_count,0) AS project_count
FROM
	(
