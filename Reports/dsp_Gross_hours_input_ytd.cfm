...
<table border="0" cellpadding="4" cellspacing="0" align="center" width="35%">
	...
	<tr class="subHeadText">
		...
		<td>
			<input type="date" name="to_date" id="to_date" min="#application.application_specific_settings.workstream_start_date#" maxlength="10" required="required" class="span3 date" />
		</td>
	</tr>
			...
			<select name="display_person" size="3" style="width:130px" multiple="multiple">
				...
				<cfoutput query="get_team_select">
					<cfif len(user_account_id)>
						<option value="#user_account_id#">#lname#, #left(name, 3)#
					</cfif>
				</cfoutput>
		</select>
		</td>
