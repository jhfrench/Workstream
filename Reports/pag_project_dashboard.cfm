...
<cfmodule template="../common_files/act_drilldown_form.cfm" function_name="edit_project" fuseaction="Customers.edit_project" field_name="project_id" processform="true" option="1" project_dashboard_return_ind="1" customer_id="#attributes.customer_id#" project_manager_id="#attributes.project_manager_id#" sort="#attributes.sort#">
