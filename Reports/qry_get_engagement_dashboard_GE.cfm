...
SELECT Project.status, Customers.description AS customers_description, Project.description,
	Project.project_code, Project.vision, Project.Budget,
	Project.Mission, Project.budget AS Expr1, REF_Billable.Billable_Type,
	Project.billable_ID, Project.Active_InD, REF_Active_Indicator.Active_Ind_Type,
