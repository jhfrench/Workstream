...
SELECT Project.Status, Inner_Query.Total_Bill_Amount, Customers.Description AS Customers_Description,
	Project.Description, Project.Project_Code, Project.Vision,
	Project.Budget, Project.Mission, Project.Budget AS Expr1,
	REF_Billable.Billable_Type, Project.Billable_ID, Project.Active_InD,
	REF_Active_Indicator.Active_Ind_Type, Flat_Rate.Months, Project.Company_ID,
	Flat_Rate.End_Date, Flat_Rate.Start_Date, Project.IE_Emp_ID,
	Emp_Contact.LName, Emp_Contact.Name, Project.project_id,
	Project.Date_Entered, Project.Date_Updated, Project.Project_End,
	Project.File_Path AS File_Path, Project.Date_Go_Live, Project.Eng_Status,
	Project.LOE	
FROM Project
