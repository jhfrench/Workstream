...
SELECT Project.project_id, Project.project_code, Project.description,
	Project.company_id, Project.project_manager_user_account_id, Project.created_date,
...
WHERE COALESCE(Project.status,0) > 0
    AND Project.company_id=#session.workstream_company_id#<cfif attributes.project_manager_user_account_id NEQ 0>
	AND Project.project_manager_user_account_id=#attributes.project_manager_user_account_id#</cfif><cfif attributes.customer_id NEQ 0>
