...
SELECT Demographics.last_name || ', ' || Demographics.first_name AS employee_name, 
	Demographics.user_account_id, 
...
FROM View_Demographics_Workstream Demographics, Demographics
	LEFT OUTER JOIN (
	...
	) AS bdata ON bdata.user_account_id=Demographics.user_account_id
	LEFT OUTER JOIN (
