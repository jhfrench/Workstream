...
<cfsilent>
	...
	Edits:
	$Log$
	Revision 1.1  2005/08/30 17:14:57  stetzer
	<>

	Revision 1.0  2005-08-30 13:06:22-04  stetzer
	Initial revision

	Revision 1.1  2005-08-26 15:35:19-04  french
	Improvements to customer-specific engagement dashboard. Task 34802

	Revision 1.0  2005-03-09 13:15:29-05  stetzer
	Initial revision
	...
	||
	END FUSEDOC ---><cfparam name="attributes.sort" default="Customers.description, Project.description">
...
WHERE Project.active_id IN (#attributes.inactive#)
	...
	AND (Project.customers_id = 982 or Project.customers_id = 1130 or Project.customers_id = 1132)
