...
<ul>
	...
	<li>Employees may "carry over" up to one week (40 hours) of PTO each calendar year.
	</li> 
	...
	<li>This PTO policy applies to all eligible employees, unless an employment agreement states otherwise. Failure to follow the PTO policy as outlined in this document may result in disciplinary action.
	</li> 
	<li>If your employment terminates for whatever reason, you will only be paid for the unused PTO days that you accumulated thru the month in which your employment terminated. You will not be paid for any PTO days that you would have accumulated during the rest of the year.
	</li> 
	<li>
