...
<!--- 	SUM(CASE WHEN project_id IN (731,886,917,948,979,1326,1359,1412) THEN Time_Entry.hours else 0 end) AS authorized_leave, --->
...
<!--- 	SUM(CASE WHEN project_id IN (706,723,878,909,940,971,1318,1351,1404) THEN Time_Entry.hours else 0 end) AS sick, --->
...
WHERE Link_Company_Emp_Contact.company_id IN (#session.workstream_selected_company_id#)<cfif NOT listcontainsnoCase(attributes.emp_id,"ALL" )>
