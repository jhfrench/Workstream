...
<cfquery name="employee_force" datasource="#application.datasources.main#">
	<cfmodule template="sql_employee_force.cfm" user_account_id="#attributes.user_account_id#" from_date="#attributes.from_date#" to_date="#attributes.to_date#" show_budgeted="#attributes.show_budgeted#" show_completed="#attributes.show_completed#">
