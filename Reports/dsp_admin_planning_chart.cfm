...
<cfoutput>
	<tr bgcolor="##c0c0c0">
		...
		<td align="center" colspan="2" class="SubHeadText">Admin/Planning</td>
	</tr>
	<tr bgcolor="##c0c0c0">
...
<cfif time_year LT lowest_year><cfset lowest_year=time_year></cfif>
	<tr<cfif (currentrow MOD 2)> bgcolor="##E1E1E1"</cfif>>
		...
		<td align="right" class="RegText">#decimalformat(ap_time)#</td>
		<td align="right" class="RegText">#decimalformat(ap_percent)#</td>
	</tr>
</cfoutput>
</table>
