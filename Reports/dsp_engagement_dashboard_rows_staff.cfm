...
<cfif status EQ 3><td align="center" class="RegText" bgcolor="red" valign="bottom">Red</cfif>
<cfif status EQ 2><td align="center" class="RegText" bgcolor="yellow" valign="bottom">Yellow</cfif>
<cfif status EQ 1><td align="center" class="RegText" bgcolor="green" valign="bottom">Green</cfif>
		</td>
