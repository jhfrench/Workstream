...
WHERE Emp_Contact.emp_id=Demographics.emp_id
	...
	AND CURRENT_TIMESTAMP BETWEEN effective_from AND COALESCE(effective_to,CURRENT_TIMESTAMP+'1 day') /*use this condition to retrieve only one record per person*/
