...
<form name="ref_product_service_edit_form" action="index.cfm?fuseaction=#fuseaction#" method="post">
	...
	<input type="submit" name="method" value="Retrieve and Edit Product Service" class="btn btn-primary" />
</form>
	...
	<tr bgcolor="##eeeeee">
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0" summary="table displays product service information">
			...
			<tr>
				...
				<td>
					<input type="number" name="sort_order" id="sort_order" value="#attributes.sort_order#" step="1" min="0" max="999" required="required" class="span5 number" />
				</td>
			</tr>
			<tr>
