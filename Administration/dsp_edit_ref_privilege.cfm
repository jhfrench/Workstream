		...
		<table width="100%" cellspacing="0" cellpadding="8" border="0" summary="Table display user accoutn inforamtion">
			<tr>
				...
				<td>
					...
					<br />
					<input type="number" name="sort_order" id="sort_order" value="#iif(attributes.privilege_id EQ 0, ('get_ref_privilege.recordcount+1'), ('get_ref_privilege.sort_order'))#" step="1" min="1" required="required" class="span5" />
				</td>
