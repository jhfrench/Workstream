...
<table width="100%" cellpadding="0" cellspacing="0" border="0" summary="table head describes the data held in the table below">
	<tr>
		<th align="left">
			<h2 style="margin:0px" id="top-side"><a href="index.cfm?fuseaction=Administration.manage_user_access">Manage User Access</a> &gt; <a href="javascript:view_user_access('<cfoutput>#attributes.user_account_id#</cfoutput>');">View User Access</a> &gt; Edit <acronym title="NASA Structure Management">NSM</acronym> Access</h2>
		</th>
	</tr>
</table>
...
<table cellspacing="1" cellpadding="4" width="100%" border="0" bgcolor="##cccccc" summary="Table allows user to edit FAAD access">
	<tr bgcolor="##cccccc"><th><strong>Edit <acronym title="NASA Structure Management">NSM</acronym> Access</strong></th></tr>
	<tr bgcolor="##eeeeee">
		<td>
				...
				<cfif get_grouper_options_and_user_privileges.recordcount NEQ 0>
					...
					<tr>
						<td colspan="#get_module_privilege_details.recordcount+2#">
							...
							<cfif variables.show_apply_to_children_ind><label for="apply_to_children_ind"><input type="checkbox" name="apply_to_children_ind" id="apply_to_children_ind" value="1" />&nbsp;Apply these selections to children <acronym title="NASA Structure Management">NSM</acronym> entities</label></cfif>
						</td>
					</tr>
					</cfoutput>
				<cfelse>
					...
					<tr>
						<td colspan="8">
							...
							<cfif compare(attributes.nsm_drilldown_organizations,0)>
								There are no options at this level to which the user can be assigned privileges. Adding privileges at a higher <acronym title="NASA Structure Management">NSM</acronym> level may present more options at this level.
							<cfelse>
								Please define the <acronym title="NASA Structure Management">NSM</acronym> structure for program year #get_program_year.description#.
							</cfif>
						</td>
					</tr>
					</cfoutput>
