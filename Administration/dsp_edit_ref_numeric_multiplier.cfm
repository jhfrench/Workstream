...
<form name="ref_numeric_multiplier_edit_form" action="index.cfm?fuseaction=#fuseaction#" method="post">
	Retrieve an existing <label for="numeric_multiplier_id">numeric multiplier</label>:<br />
	<select name="numeric_multiplier_id" id="numeric_multiplier_id">
	...
	<input type="submit" name="method" value="Retrieve and edit numeric multiplier" />
</form>
