...
<!--- -->
<fusedoc language="ColdFusion MX" specification="2.0" template="qry_deactivate_ref_priority.cfm">
	<responsibilities>
...
<cfquery name="deactivate_ref_priority" datasource="#application.datasources.main#">
UPDATE REF_Priority
SET active_ind=0
WHERE active_ind=1
	AND priority_id=#attributes.priority_id#
</cfquery>
