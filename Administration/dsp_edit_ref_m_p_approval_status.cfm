...
<form name="edit_ref_m_p_approval_status_form" action="index.cfm?fuseaction=#fuseaction#" method="post">
	...
	<input name="method" type="submit" alt="Retrieve and edit business category" value="Retrieve and edit Mentor/Prot&eacute;g&eacute; Approval Status" />
</form>
			...
			<tr>
				...
				<td><label for="sort_order">Sort Order</label>: 
					<br /><cfinput type="text" name="sort_order" id="sort_order" value=
                     #IIf(attributes.m_p_approval_status_id EQ 0, ("get_ref_m_p_approval_status.recordcount+1"), ("get_ref_m_p_approval_status.sort_order"))# size="3" maxlength="3" required="yes"
