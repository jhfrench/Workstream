<!-- Administration/qry_get_log_upload.cfm
...
SELECT LOG_Upload.upload_id, LOG_Upload.user_ip_address, LOG_Upload.original_file_name,
	LOG_Upload.archived_file_name, LOG_Upload.upload_source_id, ISNULL(REF_Upload_Source.description, 'Not specified') AS upload_source,
...
FROM LOG_Upload
	...
	LEFT OUTER JOIN REF_Upload_Source ON LOG_Upload.upload_source_id=REF_Upload_Source.upload_source_id<cfif isdefined("attributes.upload_id")>
WHERE LOG_Upload.upload_id IN (#attributes.upload_id#)</cfif>
