...
VALUES ('#attributes.email_address#', <cfif isdefined("variables.user_identification")><cfqueryparam value="#variables.user_identification#" cfsqltype="cf_sql_integer" /><cfelse>NULL</cfif>)
</cfquery>
