...
<table width="100%" cellpadding="0" cellspacing="0" border="0" summary="table head describes the data held in the table below">
	<tr>
		<th align="left"><h2 style="margin:0px" id="top-side">SCREEN LOCK MESSAGE</h2></th>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="6" summary="Table displays page locked by administrator details">
	<tr>
		<td align="center"><h3 style="margin:0px" id="top-side">The page you are trying to access is locked by the administrator. Please contact administrator for details.</h3></td>
	</tr>
</table>
</div>
</cfoutput>
