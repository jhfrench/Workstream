...
<cfif isdefined("attributes.created_by")>
	...
	<cfinclude template="qry_deactivate_ref_address_type.cfm">
	<!--- insert new record --->
	<cfinclude template="qry_insert_ref_address_type.cfm">
</cfif>

<cfinclude template="dsp_edit_ref_address_type.cfm">
