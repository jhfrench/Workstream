...
<table summary="Table displays user information">
	...
	<tr>
		...
		<td><input type="text" name="user_name" id="user_name" maxlength="4000" size="20" <cfif NOT comparenocase(attributes.action, "edit_user")>value="#user_name#" readonly="readonly"<cfelse>value="#attributes.user_name#"</cfif>/></td>
	</tr>
	<tr>
