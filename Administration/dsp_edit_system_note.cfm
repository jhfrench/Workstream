		...
		<table width="100%" cellspacing="0" cellpadding="8" border="0"  summary="Table displays notes">
			<tr>
				<td><label for="display_start_date">Display Start Date (m/d/yyyy)</label>: <br />
					...
					<input type="date" name="display_start_date" id="display_start_date" value="#dateformat(variables.display_start_date,'yyyy-mm-dd')#" min="#application.application_specific_settings_workstream_start_date#" maxlength="10" required="required" class="span3 date" />
				</td>
				<td><label for="display_end_date">Display End Date (m/d/yyyy)</label>: <br />
					...
					<input type="date" name="display_end_date" id="display_end_date" value="#dateformat(variables.display_end_date,'yyyy-mm-dd')#" min="#application.application_specific_settings_workstream_start_date#" maxlength="10" class="span3 date" />
				</td>
			</tr>
			<tr>
