		...
		<table width="100%" cellspacing="0" cellpadding="8" border="0" summary="table displays user account information">
			<tr>
				...
				<td>
					...
					<br />
					<input type="number" name="sort_order" id="sort_order" value= "#IIf(attributes.contact_type_id EQ 0, ('get_ref_contact_type.recordcount+1'), ('get_ref_contact_type.sort_order'))#" step="1" min="1" required="required" class="span5 number" />
				</td>
