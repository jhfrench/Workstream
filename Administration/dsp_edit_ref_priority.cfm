		...
		<table width="100%" cellspacing="0" cellpadding="8" border="0" summary="table displays user account information">
			<tr>
				...
				<td>
					...
					<br />
					<input type="number" name="sort_order" id="sort_order" value= "#IIf(attributes.priority_id EQ 0, ('get_ref_priority.recordcount+1'), ('get_ref_priority.sort_order'))#" step="1" min="1" required="required" class="span5 number" />
				</td>
