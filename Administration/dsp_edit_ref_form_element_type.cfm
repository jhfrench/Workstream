...
<form name="edit_ref_form_element_type_form" action="index.cfm?fuseaction=#fuseaction#" method="post">
	Retrieve an existing <label for="form_element_type_id">form element type</label>:<br />
	<select name="form_element_type_id" id="form_element_type_id">
	...
	<input type="submit" name="method" value="Retrieve and edit form element type" />
</form>
