		...
		<table width="100%" cellspacing="0" cellpadding="8" border="0" summary="Table displays new user information">
			<tr>
				...
				<td>
					...
					<br />
					<input type="number" name="sort_order" id="sort_order" value="#IIf(attributes.requirement_type_id EQ 0, ('get_requirement_type.recordcount+1'), ('get_requirement_type.sort_order'))#" step="1" min="1" required="required" class="span5 number" />
				</td>
