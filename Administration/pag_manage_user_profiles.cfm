...
<cfmodule template="../common_files/act_drilldown_form.cfm" function_name="alphabet_navigation" fuseaction="Administration.manage_user_profiles" field_name="last_initial" field_value="" field2_name="account_status_id" field2_value="#attributes.account_status_id#">
<cfmodule template="../common_files/act_drilldown_form.cfm" function_name="status_filter" fuseaction="Administration.manage_user_profiles" field_name="account_status_id" field_value="" field2_name="last_initial" field2_value="#attributes.last_initial#">
