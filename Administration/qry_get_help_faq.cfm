...
<cfif get_help_faq.recordcount>
	<cfscript>
		...
		attributes.question=get_help_faq.question;
		attributes.asked_by=get_help_faq.asked_by;
		attributes.email_requested_ind=get_help_faq.email_requested_ind;
		attributes.asker_email_address=get_help_faq.asker_email_address;
		attributes.answer=get_help_faq.answer;
		...
		attributes.questioner=get_help_faq.questioner;
	</cfscript>
<cfelse>
