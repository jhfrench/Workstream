...
<table width="100%" cellpadding="0" cellspacing="0" border="0" summary="table displays upload MDM structure infor">
	<tr>
		<td align="left"><h2 style="margin:0px"><a href="index.cfm?fuseaction=Administration.manage_nsm_structure">Manage NSM Structure</a> &gt; Upload MDM Data</h2>
		</td>
	</tr>
...
<cfif isdefined("attributes.my_file")>
	...
	<cfinclude template="../common_files/act_process_upload.cfm">
