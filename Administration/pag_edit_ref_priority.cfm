...
<cfif isdefined("attributes.created_by")>
	...
	<cfinclude template="qry_deactivate_ref_priority.cfm">
	<!--- insert new record --->
	<cfinclude template="qry_insert_ref_priority.cfm">
</cfif>

<cfinclude template="qry_get_ref_priority.cfm">

<cfinclude template="dsp_edit_ref_priority.cfm">
