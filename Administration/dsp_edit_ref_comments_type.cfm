		...
		<table width="100%" cellspacing="0" cellpadding="8" border="0" summary="Table shows account user information">
			<tr>
				...
				<td>
					...
					<br />
					<input type="number" name="sort_order" id="sort_order" value="#IIf(attributes.comments_type_id EQ 0, ('get_comments_type.recordcount+1'), ('get_comments_type.sort_order'))#" step="1" min="1" required="required" class="span5 number" />
				</td>
