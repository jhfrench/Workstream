...
<table width="100%" cellpadding="0" cellspacing="0" border="0" summary="table head describes the data held in the table below">
	<tr>
		<th align="left"><h2 style="margin:0px">Administer Help Articles</h2></th>
	</tr>
	<tr>
...
<table cellpadding="3" cellspacing="0" width="100%" border="0" cols="3" summary="Table displays help articles">
