...
<!--- -->
<fusedoc language="ColdFusion MX" specification="2.0" template="qry_insert_ref_m_P_status.cfm">
	<responsibilities>
...
<cfquery name="insert_ref_m_p_status" datasource="#application.datasources.main#">
INSERT INTO REF_m_p_status (description, sort_order, created_by,
	active_ind)
