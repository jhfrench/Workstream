...
<!---
<fusedoc language="ColdFusion MX" specification="2.0" template="pag_edit_m_p_approval_status.cfm">
	<responsibilities>
...
<cfif isdefined("attributes.created_by")>
	...
	<cfinclude template="qry_deactivate_ref_m_p_approval_status.cfm">
	<!--- insert new record --->
	<cfinclude template="qry_insert_ref_m_p_approval_status.cfm">
</cfif>

<cfinclude template="dsp_edit_ref_m_p_approval_status.cfm">
