...
<cfform name="form_help_article_entry" action="index.cfm?fuseaction=Administration.edit_help_article" method="post" class="form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="help_article_title" id="help_article_title" value="#get_help_article.help_article_title#" required="required" maxlength="60" class="span6" />
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="help_article_text">Help Article Text</label>
		<div class="controls">
			<textarea name="help_article_text" id="help_article_text" title="Help Article Text" wrap="virtual" required="required" class="span6">#get_help_article.help_article_text#</textarea>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="number" name="sort_order" id="sort_order" value="#attributes.sort_order#" step="1" min="1" required="required" class="span3 number" />
		</div>
	</div>
