...
<cfset attributes.sort_order=get_ref_module.recordcount+1>
<form name="edit_ref_module_form" action="index.cfm?fuseaction=#fuseaction#" method="post">
	Retrieve an existing <label for="module_id">module</label>:<br />
	...
	<input type="submit" name="method" value="Retrieve and edit module" />
</form>
<cfif len(attributes.method)>
	...
	<cfset attributes.sort_order=get_ref_module.sort_order>
</cfif>
		...
		<table width="100%" cellspacing="0" cellpadding="8" border="0" summary="Table displays user account information">
			<tr>
				...
				<td><label for="sort_order">Sort Order</label>: 
					<br /><cfinput type="text" name="sort_order" id="sort_order" value="#attributes.sort_order#" size="6" maxlength="6" required="yes" validate="integer" message="Please enter sort order.">
				</td>
				<td>
					<span title="describes the purpose of the radio buttons that follow">Viewable Indicator?</span><br />
					<cfinput type="radio" name="viewable_ind" id="viewable_ind_yes" value="1" checked="yes"><label for="viewable_ind_yes">Yes</label>
				 	<cfinput type="radio" name="viewable_ind" id="viewable_ind_no" value="0" ><label for="viewable_ind_no">No</label>
				</td>
			</tr>
			<tr>
				<td>
					<span title="describes the purpose of the radio buttons that follow">Assign hierarchy Privileges Ind?</span><br />
					<cfinput type="radio" name="assign_hier_privileges_ind" id="assign_hier_privileges_ind_yes" value="1" checked="yes"><label for="assign_hier_privileges_ind_yes">Yes</label>
				...
				<td>
					<span title="describes the purpose of the radio buttons that follow">Required Indicator?</span><br />
					<cfinput type="radio" name="required_ind" id="required_ind_yes" value="1" checked="yes"><label for="required_ind_yes">Yes</label>
