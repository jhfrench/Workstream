...
<div class="row-fluid">
	<div class="span3">
		...
		<b>Hire Date:</b> #dateformat(get_emp_details.hire_date,"mm/dd/yyyy")#<br />
		<cfif compare(get_emp_details.end_date,"")><b>End Date:</b> #dateformat(get_emp_details.end_date,"mm/dd/yyyy")#</cfif>
