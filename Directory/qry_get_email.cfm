...
FROM Email Em
	...
	INNER JOIN Link_Emp_Contact_Employer ON Link_Emp_Contact_Employer.emp_id = Ec.emp_id
	INNER JOIN REF_Company RCom ON Link_Emp_Contact_Employer.company_id = RCom.company_id
