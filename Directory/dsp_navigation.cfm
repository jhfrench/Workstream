...
<!--Directory/dsp_navigation.cfm
	Author: Jeromy F -->
<cfsilent>
	<!---FUSEDOC
	||
	Responsibilities: I display the workstream Directory navigation.
	||
	Name: Jeromy French
	||
	Edits:
	$Log$
Revision 1.0  2005/02/15 20:46:41  daugherty
Initial revision
...
<cfoutput>
			<a href="#request.dir_level#index.cfm?fuseaction=Administration.directory_options" class="NavText#session.workstream_text_size#">options</a>
		</td>
