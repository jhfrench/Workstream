...
<cfsilent>
	<!--- FUSEDOC
	||
	Responsibilities: I call the queries that are used to enter a new workstream user. If provided, I upload the provided image and convert the image path into a name to be used in the demographics table. Then I make an entry into the emp_contact table, where I also retrieve the emp_id for the new record. Using this emp_id I make entries into the demographics, company, location, supervisor, security, Link_Company_Emp_Contact, email_phone and emp_biography tables.
	||
	Name: Jeromy French
	||
	Edits:
...
<cftransaction isolation="READ_COMMITTED">
	...
	<cfinclude template="qry_link_company_emp_contact_entry.cfm">
