...
<table>
<tr>
	<td class="RegText" width="25%">Date Implemented</td>
	<td class="RegText" width="25%">Amount</td>
	<td class="RegText" width="25%">Increase</td>
	<td class="RegText" width="25%">% Increase</td>
</tr>
</cfoutput>
<cfoutput query="get_emp_salary_info">
	<tr>
		<td class="RegText">#dateformat(get_emp_salary_info.date_implemented,'mm/dd/yyyy')#</td>
		<td class="RegText">#dollarformat(Decrypt(get_emp_salary_info.salary,"sillyputty"))#</td>
		<td class="RegText">#dollarformat(Decrypt(get_emp_salary_info.increase_amount,"sillyputty"))#</td>
		<td class="RegText">#Decrypt(get_emp_salary_info.increase_percent,"sillyputty")#</td>
	</tr>
</cfoutput>
</table>
