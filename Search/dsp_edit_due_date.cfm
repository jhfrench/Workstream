...
<cfoutput>
	<tr>
		...
		<td class="RegText">
			...
			<select name="due_date_operator" class="RegText">
			...
			</select>&nbsp;<input type="Text" name="due_date" size="12" value="#attributes.due_date#" onclick="gfPop.fPopCalendar(this.form.due_date);checkbox_due_date()" class="RegText" maxlength="10"> 
		</td>
	</tr>
</cfoutput>
