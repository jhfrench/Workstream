...
<cfoutput>
	<tr>
		...
		<td>
			...
			<input type="date" name="date_entered" id="date_entered" min="#dateformat(application.application_specific_settings.workstream_start_date, 'yyyy-mm-dd')#" max="#dateformat(now()+30, 'yyyy-mm-dd')#" value="#dateformat(attributes.date_entered, 'yyyy-mm-dd')#" maxlength="10" class="span6 date" />
		</td>
	</tr>
</cfoutput>
