	...
	<fieldset>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<input type="text" name="date_entered" id="date_entered" size="12" maxlength="10" class="span5" />
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<input type="text" name="due_date" id="due_date" size="12" maxlength="10" class="span5" />
			</div>
		</div>
		<div class="control-group">
